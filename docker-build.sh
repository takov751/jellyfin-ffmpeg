...
EOF
    ...
    yes | apt-get install -y -o APT::Immediate-Configure=0 gcc-${GCC_VER}-source gcc-${GCC_VER}-arm-linux-gnueabihf g++-${GCC_VER}-arm-linux-gnueabihf libstdc++6-armhf-cross binutils-arm-linux-gnueabihf bison flex libtool gdb sharutils netbase libmpc-dev libmpfr-dev libgmp-dev systemtap-sdt-dev autogen expect chrpath zlib1g-dev zip libc6-dev:armhf linux-libc-dev:armhf libgcc1:armhf libcurl4-openssl-dev:armhf libfontconfig1-dev:armhf libfreetype6-dev:armhf libstdc++6:armhf libxcb-dri2-0-dev:armhf libxcb-dri3-dev:armhf libx11-dev:armhf libsdl2-dev:armhf  libxcb-present-dev:armhf libxcb-shm0-dev:armhf libxcb-sync-dev:armhf libxshmfence-dev:armhf libxext-dev:armhf libxfixes-dev:armhf libxcb1-dev:armhf libxrandr-dev:armhf
    popd
}
